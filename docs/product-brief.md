...
Structura is a living, provenance-first census of hardware products, architecture, interfaces, and relationships. The first local version supports catalogue questions; later versions may support deeper structural and historical analysis.
