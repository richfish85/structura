...
- **Choose source and dataset licensing before publication or contribution.** Include image rights, takedown handling, and redistribution boundaries.
...
- Threat-model accounts, contributions, authentication, or public hosting before adding them.
